...
import { Bot, User, FilePlus2, LayoutTemplate, CopyPlus, Eye, Share2, MoreVertical, Trash2 } from "lucide-react";
...
const options: {
  ...
  },
  {
    ...
    description: "Begin with a draft auto-generated by the Automated Documentation Module.",
    href: "/editor",
    Icon: CopyPlus,
  },
  {
        ...
        <main className="flex-1 flex flex-col justify-between p-4 sm:p-8 bg-background">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
              {options.map((option) => (
                <Link href={option.href} key={option.title} onClick={(e) => handleOptionClick(e, option.id)}>
